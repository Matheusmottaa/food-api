...
create table restaurant (id bigint not null auto_increment, active bit, address_complement varchar(255), address_neighborhood varchar(255), address_number varchar(255), address_street varchar(255), address_zip_code varchar(255), delivery_tax decimal(19,2) not null, name varchar(255) not null, open bit, register_date datetime not null, updated_date datetime not null, address_city_id bigint, kitchen_id bigint, primary key (id)) engine=InnoDB;
create table restaurant_type_payments (restaurant_id bigint not null, type_payment_id bigint not null) engine=InnoDB;
...
create table type_payment (id bigint not null auto_increment, description varchar(255) not null, primary key (id)) engine=InnoDB;
create table user (id bigint not null auto_increment, created_at datetime, email varchar(255) not null, name varchar(255) not null, password varchar(255) not null, primary key (id)) engine=InnoDB;
